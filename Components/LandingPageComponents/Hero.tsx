  ...
  return (
    <>
      <section className="bg-white w-full flex justify-center pt-30">
        <div className="max-w-6xl mx-auto lg:min-w-[860px] min-h-[970px] sm:grid-cols-2 grid-cols-2">
          <div className=" flex flex-col items-center tems-start text-left lg:max-w-[850px]">
            ...
            <h2 className="text-gray-500 text-center font-bold text-xs md:text-sm lg:max-w-[425px]">
